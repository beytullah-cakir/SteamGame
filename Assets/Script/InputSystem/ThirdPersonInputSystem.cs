...
public partial class @ThirdPersonInputSystem: IInputActionCollection2, IDisposable
{
    ...
    ~@ThirdPersonInputSystem()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, ThirdPersonInputSystem.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, ThirdPersonInputSystem.UI.Disable() has not been called.");
    }
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@ThirdPersonInputSystem wrapper) { m_Wrapper = wrapper; }
        /// <summary>
